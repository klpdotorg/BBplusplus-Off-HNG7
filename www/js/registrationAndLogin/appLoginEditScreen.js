...
Game.appLoginEditScreen.prototype = {
	...
	create: function (game) {
		...
		_this.basePath = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffHinG7/Files/Download/.gameFilesBB++V10_2/www/";

		//* nEED to change this ****
		_this.fullSize = 199718252;
		...
		_this.zipFiles = [["Assets1.zip", 981561], ["Assets2.zip", 20384015], ["Assets4.zip", 20580194], ["EnglishquestionSounds.zip", 44579738], ["HindiquestionSounds.zip", 57950883],
		["KannadaquestionSounds.zip", 51499061], ["sounds.zip", 3742800]];//3,742,800
		...
		if (_this.user.language == "English") {
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-ADD-G7/Hindi", _this.user.language + "/HindiquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-ADD-G7/Kannada", _this.user.language + "/KANquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-ADD-G7/Odiya", _this.user.language + "/ODIquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// }
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-ADD-G7/Marathi", _this.user.language + "/MARquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// }
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-ADD-G7/Tamil", _this.user.language + "/TMquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
	...
	checkIfAllAssetsPresent: function () {
		if (_this.counter < _this.fileCheck.length) {
			...
			window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffHinG7/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 
